...
const TypingText = ({ text, active = false, speed = 40, onComplete, onStart }) => {
    ...
    }, [text, active, speed, onComplete, onStart]);
            ...
            <div className="relative z-10 text-center px-6 max-w-4xl flex flex-col items-center">
                ...
                >
                    ...
                    <div className="text-sm md:text-base text-gray-500 font-light mb-16 leading-loose break-keep flex flex-col items-center space-y-1">
                        <TypingText text="본질 위에 새로운 시선을 더합니다." active={completedLines === 0} speed={60} onStart={handleStart} onComplete={handleLineComplete} />
                        <TypingText text="삶의 가치와 공간을 가다듬어" active={completedLines === 1} speed={60} onComplete={handleLineComplete} />
                        <TypingText text="그 여유와 비전을 함께 나눕니다." active={completedLines === 2} speed={60} onComplete={handleLineComplete} />
                    </div>
