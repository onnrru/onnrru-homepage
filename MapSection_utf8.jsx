...
const ALL_LAYERS = [
    { id: 'LP_PA_CBND_BUBUN', label: '吏?곷룄', category: '湲곕낯' },

    { id: 'LT_C_UQ111', label: '?꾩떆吏??, category: '?⑸룄吏?? },
    { id: 'LT_C_UQ112', label: '愿由ъ???, category: '?⑸룄吏?? },
    { id: 'LT_C_UQ113', label: '?띾┝吏??, category: '?⑸룄吏?? },
    { id: 'LT_C_UQ114', label: '?먯뿰?섍꼍蹂댁쟾吏??, category: '?⑸룄吏?? },

    { id: 'LT_C_UQ129', label: '媛쒕컻吏꾪씎吏援?, category: '?⑸룄吏援? },
    { id: 'LT_C_UQ121', label: '寃쎄?吏援?, category: '?⑸룄吏援? },
    { id: 'LT_C_UQ123', label: '怨좊룄吏援?, category: '?⑸룄吏援? },
    { id: 'LT_C_UQ122', label: '誘멸?吏援?, category: '?⑸룄吏援? },
    { id: 'LT_C_UQ125', label: '諛⑹옱吏援?, category: '?⑸룄吏援? },
    { id: 'LT_C_UQ124', label: '諛⑺솕吏援?, category: '?⑸룄吏援? },
    { id: 'LT_C_UQ126', label: '蹂댁〈吏援?, category: '?⑸룄吏援? },
    { id: 'LT_C_UQ127', label: '?쒖꽕蹂댄샇吏援?, category: '?⑸룄吏援? },
    { id: 'LT_C_UQ128', label: '痍⑤씫吏援?, category: '?⑸룄吏援? },
    { id: 'LT_C_UQ130', label: '?뱀젙?⑸룄?쒗븳吏援?, category: '?⑸룄吏援? },

    { id: 'LT_C_UD801', label: '媛쒕컻?쒗븳援ъ뿭', category: '?⑸룄援ъ뿭' },
    { id: 'LT_C_UQ141', label: '援?넗怨꾪쉷援ъ뿭', category: '?⑸룄援ъ뿭' },
    { id: 'LT_C_UQ162', label: '?꾩떆?먯뿰怨듭썝援ъ뿭', category: '?⑸룄援ъ뿭' },
    { id: 'LT_C_UM000', label: '媛異뺤궗?≪젣?쒓뎄??, category: '?⑸룄援ъ뿭' },
    { id: 'LT_C_UO601', label: '愿愿묒?', category: '?⑸룄援ъ뿭' },
    { id: 'LT_C_UD610', label: '援???꾨?二쇳깮', category: '?⑸룄援ъ뿭' },
    { id: 'LT_C_UP401', label: '湲됯꼍?ъ옱?댁삁諛⑹???, category: '?⑸룄援ъ뿭' },
    { id: 'LT_C_UM301', label: '?湲고솚寃쎄퇋?쒖???, category: '?⑸룄援ъ뿭' },
    { id: 'LT_C_UF901', label: '諛깅몢?媛꾨낫?몄???, category: '?⑸룄援ъ뿭' },
    { id: 'LT_C_UH701', label: '踰ㅼ쿂湲곗뾽?≪꽦吏??, category: '?⑸룄援ъ뿭' },
    { id: 'LT_C_UD620', label: '蹂닿툑?먮━二쇳깮', category: '?⑸룄援ъ뿭' },
    { id: 'LT_C_UF151', label: '?곕┝蹂댄샇援ъ뿭', category: '?⑸룄援ъ뿭' },
    { id: 'LT_C_UM901', label: '?듭?蹂댄샇吏??, category: '?⑸룄援ъ뿭' },
    { id: 'LT_C_UB901', label: '?쒖옣?뺣퉬援ъ뿭', category: '?⑸룄援ъ뿭' },
    { id: 'LT_C_UM221', label: '?쇱깮?숈떇臾쇰낫??, category: '?⑸룄援ъ뿭' },
    { id: 'LT_C_UJ401', label: '?⑥쿇吏援?, category: '?⑸룄援ъ뿭' },
    { id: 'LT_C_UH501', label: '?좏넻?⑥?', category: '?⑸룄援ъ뿭' },
    { id: 'LT_C_UH402', label: '?먯쑀臾댁뿭吏??, category: '?⑸룄援ъ뿭' },
    { id: 'LT_C_UD601', label: '二쇨굅?섍꼍媛쒖꽑吏援щ룄', category: '?⑸룄援ъ뿭' },
    { id: 'LT_C_UO101', label: '?숆탳?섍꼍?꾩깮?뺥솕援ъ뿭', category: '?⑸룄援ъ뿭' },

    { id: 'LT_C_LHZONE', label: '?ъ뾽吏援ш꼍怨꾨룄', category: '?꾩떆怨꾪쉷' },
    { id: 'LT_C_LHBLPN', label: '?좎??댁슜怨꾪쉷??LH)', category: '?꾩떆怨꾪쉷' },
    { id: 'LT_C_UPISUQ153', label: '?꾩떆怨꾪쉷(怨듦컙?쒖꽕)', category: '?꾩떆怨꾪쉷' },
    { id: 'LT_C_UPISUQ155', label: '?꾩떆怨꾪쉷(怨듦났臾명솕)', category: '?꾩떆怨꾪쉷' },
    { id: 'LT_C_UPISUQ152', label: '?꾩떆怨꾪쉷(援먰넻?쒖꽕)', category: '?꾩떆怨꾪쉷' },
    { id: 'LT_C_UPISUQ159', label: '?꾩떆怨꾪쉷(湲고?)', category: '?꾩떆怨꾪쉷' },
    { id: 'LT_C_UPISUQ151', label: '?꾩떆怨꾪쉷(?꾨줈)', category: '?꾩떆怨꾪쉷' },
    { id: 'LT_C_UPISUQ156', label: '?꾩떆怨꾪쉷(諛⑹옱?쒖꽕)', category: '?꾩떆怨꾪쉷' },
    { id: 'LT_C_UPISUQ157', label: '?꾩떆怨꾪쉷(蹂닿굔?꾩깮)', category: '?꾩떆怨꾪쉷' },
    { id: 'LT_C_UPISUQ154', label: '?꾩떆怨꾪쉷(?좏넻怨듦툒)', category: '?꾩떆怨꾪쉷' },
    { id: 'LT_C_UPISUQ158', label: '?꾩떆怨꾪쉷(?섍꼍湲곗큹)', category: '?꾩떆怨꾪쉷' },
    { id: 'LT_C_UPISUQ161', label: '吏援щ떒?꾧퀎??, category: '?꾩떆怨꾪쉷' },
    { id: 'LT_C_UPISUQ171', label: '媛쒕컻?됱쐞?덇??쒗븳', category: '?꾩떆怨꾪쉷' },
    { id: 'LT_C_UPISUQ174', label: '媛쒕컻?됱쐞?덇??꾩?', category: '?꾩떆怨꾪쉷' },
    { id: 'LT_C_UPISUQ173', label: '湲곕컲?쒖꽕遺?닿뎄??, category: '?꾩떆怨꾪쉷' },
    { id: 'LT_C_UPISUQ175', label: '?좎?嫄곕옒?덇?援ъ뿭', category: '?꾩떆怨꾪쉷' },

    { id: 'LT_C_KFDRSSIGUGRADE', label: '?곕텋?꾪뿕?덉륫吏??, category: '?섍꼍/?곕┝' },
    { id: 'LT_C_AGRIXUE101', label: '?띿뾽吏꾪씎吏??룄', category: '?섍꼍/?곕┝' },
    { id: 'LT_C_AGRIXUE102', label: '?곷냽?ш굔遺덈━?띿?', category: '?섍꼍/?곕┝' },
    { id: 'LT_C_FLISFK300', label: '?곗?(蹂댁븞由?', category: '?섍꼍/?곕┝' },
    { id: 'LT_C_FLISFK100', label: '?곗?(?먯뿰?댁뼇由?', category: '?섍꼍/?곕┝' },
    { id: 'LT_C_FLISFK200', label: '?곗?(梨꾩쥌由?', category: '?섍꼍/?곕┝' },
    { id: 'LT_C_UF602', label: '?꾩뾽諛륁궛珥뚯쭊?κ텒??, category: '?섍꼍/?곕┝' },
    { id: 'LT_C_FSDIFRSTS', label: '?곕┝?낆???, category: '?섍꼍/?곕┝' },

    { id: 'LT_C_UP201', label: '?ы빐?꾪뿕吏援?, category: '?ы빐/?덉쟾' },
    { id: 'LT_P_EDRSE002', label: '吏吏꾨??쇱냼', category: '?ы빐/?덉쟾' },
    { id: 'LT_P_ETQSHELTER', label: '吏吏꾪빐?쇰??쇱냼', category: '?ы빐/?덉쟾' },
    { id: 'LT_C_USFSFFB', label: '?뚮갑?쒓??좉뎄??, category: '?ы빐/?덉쟾' },
    { id: 'LT_C_CDFRS100FRQ', label: '?댁븞移⑥닔(100??', category: '?ы빐/?덉쟾' },
    { id: 'LT_C_CDFRSMAXFRQ', label: '?댁븞移⑥닔(理쒕?踰붾엺)', category: '?ы빐/?덉쟾' },

    { id: 'LT_C_WGISPLTALK', label: '媛쒕컻?좊룄?곗븞', category: '?섏옄???댁뼇' },
    { id: 'LT_C_WGISPLROW', label: '媛쒕컻議곗젙?곗븞', category: '?섏옄???댁뼇' },
    { id: 'LT_C_WGISPLUSE', label: '?댁슜?곗븞', category: '?섏옄???댁뼇' },
    { id: 'LT_C_WGISPLABS', label: '?덈?蹂댁쟾?곗븞', category: '?섏옄???댁뼇' },
    { id: 'LT_C_WGISPLJUN', label: '以蹂댁쟾?곗븞', category: '?섏옄???댁뼇' },
    { id: 'LT_C_WKMSBSN', label: '?쒖?沅뚯뿭(?섏옄??', category: '?섏옄???댁뼇' },
    { id: 'LT_C_WKMSTRM', label: '?섏쿇留?, category: '?섏옄???댁뼇' },
    { id: 'LT_C_UM710', label: '?곸닔?먮낫??, category: '?섏옄???댁뼇' },
    { id: 'LT_C_WGISARFISHER', label: '?섏궛?먯썝蹂댄샇援ъ뿭', category: '?섏옄???댁뼇' },
    { id: 'LT_C_WGISARWET', label: '?듭?蹂댄샇援ъ뿭', category: '?섏옄???댁뼇' },
    { id: 'LT_L_TOISDEPCNTAH', label: '?댁븞??, category: '?섏옄???댁뼇' },

    { id: 'LT_C_ADSIDO', label: '愿묒뿭?쒕룄', category: '?됱젙/湲고?' },
    { id: 'LT_C_ADSIGG', label: '?쒓뎔援?, category: '?됱젙/湲고?' },
    { id: 'LT_C_ADEMD', label: '?띾㈃??, category: '?됱젙/湲고?' },
    { id: 'LT_C_RI', label: '由?, category: '?됱젙/湲고?' },
    { id: 'LT_L_SPRD', label: '?꾨줈紐낆＜?뚮룄濡?, category: '?됱젙/湲고?' },
    { id: 'LT_C_SPBD', label: '?꾨줈紐낆＜?뚭굔臾?, category: '?됱젙/湲고?' },
    { id: 'LT_P_NSNMSSITENM', label: '援??吏紐?, category: '?됱젙/湲고?' }
];
...
const MapSection = ({
    ...
    // ====== Measurement logic (湲곗〈 ?좎?) ======
    useEffect(() => {
        if (!mapObj || (!measureMode && !radiusMode)) {
